                               ...
                               int tag, int aclass, char opt, ASN1_TLC *ctx)
{
    ...
    case ASN1_ITYPE_SEQUENCE:
        ...
        /* If no IMPLICIT tagging set to SEQUENCE, UNIVERSAL 如果没有 IMPLICIT 标记设置为 SEQUENCE，UNIVERSAL*/
        if (tag == -1) {
            tag = V_ASN1_SEQUENCE;
            aclass = V_ASN1_UNIVERSAL;
        }
        /* Get SEQUENCE length and update len, p 获取序列长度并更新 len, p*/
