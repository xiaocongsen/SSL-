...
{
//    printf("dddddddddddddddd bwrite_conv\n");
    int ret;
...
//    printf("xcs1 bwrite_conv 111111111111111 ret:%d name:%s\n",ret,bio->method->name);
    if (ret <= 0) {
        *written = 0;
        return ret;
    }
...
{
    printf("dddddddddddddddd bread_conv\n");
    int ret;
...
//    printf("xcs1 bread_conv 111111111111111111111 ret:%d name:%s\n",ret,bio->method->name);
    if (ret <= 0) {
        *readbytes = 0;
        return ret;
    }
