...
static int GMold_old_hmac_decode(EVP_PKEY *pkey,
...
static int GMold_old_hmac_encode(const EVP_PKEY *pkey, unsigned char **pder)
{
    int inc;
    ASN1_OCTET_STRING *os = EVP_PKEY_get0(pkey);
    if (pder) {
...
const EVP_PKEY_ASN1_METHOD GMold_hmac_asn1_meth = {
    GMold_NID_hmac,
    GMold_NID_hmac,
    0,
    ...
    hmac_key_free,
    hmac_pkey_ctrl,
    GMold_old_hmac_decode,
    GMold_old_hmac_encode,
    NULL,
    NULL,
    NULL,
    NULL,
