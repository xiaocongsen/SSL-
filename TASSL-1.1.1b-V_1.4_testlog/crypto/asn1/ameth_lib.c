...
extern const EVP_PKEY_ASN1_METHOD GMold_eckey_asn1_meth;
const EVP_PKEY_ASN1_METHOD *GMold_eckey_asn1_method(void)
{
    return &GMold_eckey_asn1_meth;
}

extern const EVP_PKEY_ASN1_METHOD GMold_hmac_asn1_meth;
const EVP_PKEY_ASN1_METHOD *GMold_hmac_asn1_method(void)
{
    return &GMold_hmac_asn1_meth;
}
