...
#  define GMold_SSL_OP_NO_GMTLS                                0x10000000U
...
__owur SSL_CTX *GMold_SSL_CTX_new(const SSL_METHOD *meth);
...
__owur int GMold_SSL_set_fd(SSL *s, int fd);
...
__owur int SSL_CTX_use_PrivateKey_file(SSL_CTX *ctx, const char *file,
                                       int type);
__owur int GMold_SSL_CTX_use_PrivateKey_file(SSL_CTX *ctx, const char *file, int type);
...
__owur int GMold_SSL_CTX_use_certificate(SSL_CTX *ctx, X509 *x);
...
__owur int GMold_SSL_CTX_check_private_key(const SSL_CTX *ctx);
#ifndef OPENSSL_NO_CNSM
...
__owur int GMold_SSL_read(SSL *s, void *buf, int num);
...
__owur int GMold_SSL_write(SSL *s, const void *buf, int num);
...
__owur const SSL_METHOD *GMold_client_method(void);
#endif
...
__owur int SSL_CTX_load_verify_locations(SSL_CTX *ctx, const char *CAfile,
                                         const char *CApath);
__owur int GMold_SSL_CTX_load_verify_locations(SSL_CTX *ctx, const char *CAfile,
                                  const char *CApath);
