...
# define GMold_X509_LOOKUP_load_file(x,name,type) \
                GMold_X509_LOOKUP_ctrl((x),X509_L_FILE_LOAD,(name),(long)(type),NULL)
...
int GMold_X509_STORE_CTX_get1_issuer(X509 **issuer, X509_STORE_CTX *ctx, X509 *x);
...
int X509_LOOKUP_ctrl(X509_LOOKUP *ctx, int cmd, const char *argc,
                     long argl, char **ret);
int GMold_X509_LOOKUP_ctrl(X509_LOOKUP *ctx, int cmd, const char *argc, long argl,
                     char **ret);
...
int GMold_X509_STORE_load_locations(X509_STORE *ctx, const char *file,
                              const char *path);
