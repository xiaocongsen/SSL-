...
int tls13_generate_master_secret(SSL *s, unsigned char *out,
                                 ...
                                 size_t *secret_size)
{
    printf("ddddddddddd tls13_generate_master_secret \n");
...
size_t tls13_final_finish_mac(SSL *s, const char *str, size_t slen,
                             unsigned char *out)
{
    printf("ddddddddddd tls13_final_finish_mac \n");
    const EVP_MD *md = ssl_handshake_md(s);
    unsigned char hash[EVP_MAX_MD_SIZE];
...
{
    printf("ddddddddddd tls13_setup_key_block \n");
    const EVP_CIPHER *c;
    const EVP_MD *hash;
...
{
    printf("ddddddddddd tls13_change_cipher_state \n");
...
{
    printf("ddddddddddd tls13_alert_code \n");
...
{
    printf("ddddddddddd tls13_export_keying_material \n");
