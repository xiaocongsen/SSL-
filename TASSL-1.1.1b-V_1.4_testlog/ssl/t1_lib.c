...
SSL3_ENC_METHOD const GMTLS_enc_data = {
    GMold_tls1_enc,
    GMold_tls1_mac,
    GMold_tls1_setup_key_block,
    GMold_tls1_generate_master_secret,
    GMold_tls1_change_cipher_state,
    GMold_tls1_final_finish_mac,
    // TLS1_FINISH_MAC_LENGTH,  12
    TLS_MD_CLIENT_FINISH_CONST, TLS_MD_CLIENT_FINISH_CONST_SIZE,
    TLS_MD_SERVER_FINISH_CONST, TLS_MD_SERVER_FINISH_CONST_SIZE,
    gmtls_alert_code,
    GMold_tls1_export_keying_material,
    SSL_ENC_FLAG_EXPLICIT_IV,
    // SSL3_HM_HEADER_LENGTH,       4
    ssl3_set_handshake_header,
    tls_close_construct_packet,
    GMold_ssl3_handshake_write
};
...
static const TLS_GROUP_INFO GMold_nid_list[] = {
    {GMold_NID_sect163k1, 80, TLS_CURVE_CHAR2}, /* sect163k1 (1) */
    {GMold_NID_sect163r1, 80, TLS_CURVE_CHAR2}, /* sect163r1 (2) */
    {GMold_NID_sect163r2, 80, TLS_CURVE_CHAR2}, /* sect163r2 (3) */
    {GMold_NID_sect193r1, 80, TLS_CURVE_CHAR2}, /* sect193r1 (4) */
    {GMold_NID_sect193r2, 80, TLS_CURVE_CHAR2}, /* sect193r2 (5) */
    {GMold_NID_sect233k1, 112, TLS_CURVE_CHAR2}, /* sect233k1 (6) */
    {GMold_NID_sect233r1, 112, TLS_CURVE_CHAR2}, /* sect233r1 (7) */
    {GMold_NID_sect239k1, 112, TLS_CURVE_CHAR2}, /* sect239k1 (8) */
    {GMold_NID_sect283k1, 128, TLS_CURVE_CHAR2}, /* sect283k1 (9) */
    {GMold_NID_sect283r1, 128, TLS_CURVE_CHAR2}, /* sect283r1 (10) */
    {GMold_NID_sect409k1, 192, TLS_CURVE_CHAR2}, /* sect409k1 (11) */
    {GMold_NID_sect409r1, 192, TLS_CURVE_CHAR2}, /* sect409r1 (12) */
    {GMold_NID_sect571k1, 256, TLS_CURVE_CHAR2}, /* sect571k1 (13) */
    {GMold_NID_sect571r1, 256, TLS_CURVE_CHAR2}, /* sect571r1 (14) */
    {GMold_NID_secp160k1, 80, TLS_CURVE_PRIME}, /* secp160k1 (15) */
    {GMold_NID_secp160r1, 80, TLS_CURVE_PRIME}, /* secp160r1 (16) */
    {GMold_NID_secp160r2, 80, TLS_CURVE_PRIME}, /* secp160r2 (17) */
    {GMold_NID_secp192k1, 80, TLS_CURVE_PRIME}, /* secp192k1 (18) */
    {GMold_NID_X9_62_prime192v1, 80, TLS_CURVE_PRIME}, /* secp192r1 (19) */
    {GMold_NID_secp224k1, 112, TLS_CURVE_PRIME}, /* secp224k1 (20) */
    {GMold_NID_secp224r1, 112, TLS_CURVE_PRIME}, /* secp224r1 (21) */
    {GMold_NID_secp256k1, 128, TLS_CURVE_PRIME}, /* secp256k1 (22) */
    {GMold_NID_X9_62_prime256v1, 128, TLS_CURVE_PRIME}, /* secp256r1 (23) */
    {GMold_NID_secp384r1, 192, TLS_CURVE_PRIME}, /* secp384r1 (24) */
    {GMold_NID_secp521r1, 256, TLS_CURVE_PRIME}, /* secp521r1 (25) */
    {GMold_NID_brainpoolP256r1, 128, TLS_CURVE_PRIME}, /* brainpoolP256r1 (26) */
    {GMold_NID_brainpoolP384r1, 192, TLS_CURVE_PRIME}, /* brainpoolP384r1 (27) */
    {GMold_NID_brainpoolP512r1, 256, TLS_CURVE_PRIME}, /* brainpool512r1 (28) */
    {GMold_NID_X25519, 128, TLS_CURVE_CUSTOM}, /* X25519 (29) */
    {GMold_NID_sm2p256v1, 128, TLS_CURVE_PRIME}, /* sm2p256v1 (30) */
};
...
int GMold_tls1_ec_nid2curve_id(int nid)
{
    size_t i;
    for (i = 0; i < OSSL_NELEM(GMold_nid_list); i++) {
        if (GMold_nid_list[i].nid == nid)
            return i + 1;
    }
    return 0;
}

int GMold_tls1_set_curves(unsigned char **pext, size_t *pextlen,
                    int *curves, size_t ncurves)
{
    ...
    for (i = 0, p = clist; i < ncurves; i++) {
        ...
        int id;
        id = GMold_tls1_ec_nid2curve_id(curves[i]);
        idmask = 1L << id;
...
int GMold_tls1_set_curves_list(unsigned char **pext, size_t *pextlen, const char *str)
{
    nid_cb_st ncb;
    ncb.nidcnt = 0;
    ...
    if (pext == NULL)
        return 1;
    return GMold_tls1_set_curves(pext, pextlen, ncb.nid_arr, ncb.nidcnt);
}
...
static const unsigned char GMold_tls12_sigalgs[] = {
    ...
    GMold_TLSEXT_hash_sm3, GMold_TLSEXT_signature_sm2sign,
};
...
{
    printf("ddddddddddd tls12_get_psigalgs \n");
    /*
...
size_t GMold_tls12_get_psigalgs(SSL *s, const unsigned char **psigs)
{
    /*
     * If Suite B mode use Suite B sigalgs only, ignore any other
     * preferences.
     */
    uint32_t ret = tls1_suiteb(s);
    switch (ret) {
    case SSL_CERT_FLAG_SUITEB_128_LOS:
        *psigs = suiteb_sigalgs;
    ...
    if (s->server && s->cert->client_sigalgs) {
        *psigs = s->cert->client_sigalgs;
        ...
        printf("GMold_tls12_get psigalgs 0000000000000\n");
        *psigs = s->cert->conf_sigalgs;
        return s->cert->conf_sigalgslen;
    } else {
        *psigs = GMold_tls12_sigalgs;
        return sizeof(GMold_tls12_sigalgs);
    }
}
...
int tls12_check_peer_sigalg(SSL *s, uint16_t sig, EVP_PKEY *pkey)
{
    ...
    if (SSL_IS_TLS13(s)) {
        ...
        if (pkeyid == EVP_PKEY_DSA) {
         ...
         /* Only allow PSS for TLS 1.3 */     //TODO xcs win的usbkey证书回调无法通过PSS的认证 除了屏蔽还能怎么解决？？
...
{
    printf("ddddddddddd ssl_set_client_disabled \n");
    s->s3->tmp.mask_a = 0;
    s->s3->tmp.mask_k = 0;
...
void GMold_ssl_set_client_disabled(SSL *s)
{
    s->s3->tmp.mask_a = 0;
    s->s3->tmp.mask_k = 0;
    GMold_ssl_set_sig_mask(&s->s3->tmp.mask_a, s, SSL_SECOP_SIGALG_MASK);
    GMold_ssl_get_client_min_max_version(s, &s->s3->tmp.min_ver, &s->s3->tmp.max_ver);
#ifndef OPENSSL_NO_PSK
    /* with PSK there must be client callback set */
    if (!s->psk_client_callback) {
        s->s3->tmp.mask_a |= SSL_aPSK;
...
{
    printf("ddddddddddd ssl_cipher_disabled \n");
...
int GMold_ssl_cipher_disabled(SSL *s, const SSL_CIPHER *c, int op, int ecdhe)
{
    if (c->algorithm_mkey & s->s3->tmp.mask_k
        || c->algorithm_auth & s->s3->tmp.mask_a)
        {
            printf("GMold_ssl_cipher_disabled 1111111111111111111\n");
            return 1;
        }
        
    if (s->s3->tmp.max_ver == 0)
        {
            printf("GMold_ssl_cipher_disabled 2222222222222222\n");
            return 1;
        }
    
    if (!SSL_IS_DTLS(s) && (s->version != GMTLS_VERSION ) &&  ((c->min_tls > s->s3->tmp.max_ver)
                            || (c->max_tls < s->s3->tmp.min_ver)))
        {
            printf("GMold_ssl_cipher_disabled c->min_tls:%d,c->max_tls:%d,s->s3->tmp.max_ver:%d,s->s3->tmp.min_ver:%d\n",c->min_tls,c->max_tls,s->s3->tmp.max_ver,s->s3->tmp.min_ver);
            return 1;
        }
    if (SSL_IS_DTLS(s) &&(s->version != GMTLS_VERSION ) &&  (DTLS_VERSION_GT(c->min_dtls, s->s3->tmp.max_ver)
                           || DTLS_VERSION_LT(c->max_dtls, s->s3->tmp.min_ver)))
        {
            printf("GMold_ssl_cipher_disabled 44444444444444444444444\n");
            return 1;
        }
    int ret = !GMold_ssl_security(s, op, c->strength_bits, 0, (void *)c);
    return ret;
}
...
{
    printf("ddddddddddd tls12_sigalg_allowed \n");
...
static const tls12_lookup GMold_tls12_md[] = {
    {GMold_NID_md5, TLSEXT_hash_md5},
    {GMold_NID_sha1, TLSEXT_hash_sha1},
    {GMold_NID_sha224, TLSEXT_hash_sha224},
    {GMold_NID_sha256, TLSEXT_hash_sha256},
    {GMold_NID_sha384, TLSEXT_hash_sha384},
    {GMold_NID_sha512, TLSEXT_hash_sha512},
    {GMold_NID_id_GostR3411_94, TLSEXT_hash_gostr3411},
    {GMold_NID_id_GostR3411_2012_256, TLSEXT_hash_gostr34112012_256},
    {GMold_NID_id_GostR3411_2012_512, TLSEXT_hash_gostr34112012_512},
    {GMold_NID_sm3, GMold_TLSEXT_hash_sm3},
};

static const tls12_lookup GMold_tls12_sig[] = {
    {GMold_NID_rsaEncryption, TLSEXT_signature_rsa},
    {GMold_NID_dsa, TLSEXT_signature_dsa},
    {GMold_NID_X9_62_id_ecPublicKey, TLSEXT_signature_ecdsa},
    {GMold_NID_sm2sign, GMold_TLSEXT_signature_sm2sign},
    //{EVP_PKEY_EC, GMold_TLSEXT_signature_sm2sign},
    {GMold_NID_id_GostR3410_2001, TLSEXT_signature_gostr34102001},
    {GMold_NID_id_GostR3410_2012_256, TLSEXT_signature_gostr34102012_256},
    {GMold_NID_id_GostR3410_2012_512, TLSEXT_signature_gostr34102012_512}
};

static int GMold_tls12_find_id(int nid, const tls12_lookup *table, size_t tlen);
int GMold_tls12_get_sigid(const EVP_PKEY *pk);

int GMold_tls12_get_sigandhash(unsigned char *p, const EVP_PKEY *pk, const EVP_MD *md)
{
    int sig_id, md_id;
    if (!md)
        return 0;
    md_id = GMold_tls12_find_id(EVP_MD_type(md), GMold_tls12_md, OSSL_NELEM(GMold_tls12_md));
    if (md_id == -1)
        return 0;
    sig_id = GMold_tls12_get_sigid(pk);
    if (sig_id == -1)
        return 0;
...
int GMold_tls12_get_sigid(const EVP_PKEY *pk)
{
    /* tls12_find_id() can not find GMold_TLSEXT_signature_sm2sign with EVP_PKEY_EC */
    if (EVP_PKEY_id(pk) == GMold_EVP_PKEY_EC && EC_GROUP_get_curve_name(
        EC_KEY_get0_group(EVP_PKEY_get0_EC_KEY((EVP_PKEY *)pk))) == GMold_NID_sm2p256v1)
        return GMold_TLSEXT_signature_sm2sign;
    return GMold_tls12_find_id(EVP_PKEY_id(pk), GMold_tls12_sig, OSSL_NELEM(GMold_tls12_sig));
}
...
} GMold_tls12_hash_info;

static const GMold_tls12_hash_info GMold_tls12_md_info[] = {
    {GMold_NID_md5, 64, SSL_MD_MD5_IDX, TLSEXT_hash_md5},
    {GMold_NID_sha1, 80, SSL_MD_SHA1_IDX, TLSEXT_hash_sha1},
    {GMold_NID_sha224, 112, SSL_MD_SHA224_IDX, TLSEXT_hash_sha224},
    {GMold_NID_sha256, 128, SSL_MD_SHA256_IDX, TLSEXT_hash_sha256},
    {GMold_NID_sha384, 192, SSL_MD_SHA384_IDX, TLSEXT_hash_sha384},
    {GMold_NID_sha512, 256, SSL_MD_SHA512_IDX, TLSEXT_hash_sha512},
    {GMold_NID_id_GostR3411_94, 128, SSL_MD_GOST94_IDX, TLSEXT_hash_gostr3411},
    {GMold_NID_id_GostR3411_2012_256, 128, SSL_MD_GOST12_256_IDX,
     TLSEXT_hash_gostr34112012_256},
    {GMold_NID_id_GostR3411_2012_512, 256, SSL_MD_GOST12_512_IDX,
     TLSEXT_hash_gostr34112012_512},
    {GMold_NID_sm3, 128, SSL_MD_SM3_IDX, GMold_TLSEXT_hash_sm3},
};

static const GMold_tls12_hash_info *GMold_tls12_get_hash_info(unsigned char hash_alg)
{
    unsigned int i;
    if (hash_alg == 0)
        return NULL;

    for (i = 0; i < OSSL_NELEM(GMold_tls12_md_info); i++) {
        if (GMold_tls12_md_info[i].tlsext_hash == hash_alg)
            return GMold_tls12_md_info + i;
    }

    return NULL;
}

static int GMold_tls12_get_pkey_idx(unsigned char sig_alg)
{
    switch (sig_alg) {
    ...
    case GMold_TLSEXT_signature_sm2sign:
        return GMold_SSL_PKEY_SM2;
...
static int GMold_tls12_sigalg_allowed(SSL *s, int op, const unsigned char *ptmp)
{
    /* See if we have an entry in the hash table and it is enabled */
    const GMold_tls12_hash_info *hinf = GMold_tls12_get_hash_info(ptmp[0]);
    if (hinf == NULL || ssl_md(hinf->md_idx) == NULL)
        return 0;
    /* See if public key algorithm allowed */
    if (GMold_tls12_get_pkey_idx(ptmp[1]) == -1)
        return 0;
    /* Finally see if security callback allows it */
    return GMold_ssl_security(s, op, hinf->secbits, hinf->nid, (void *)ptmp);
}
...
{
    printf("ddddddddddd ssl_set_sig_mask \n");
...
void GMold_ssl_set_sig_mask(uint32_t *pmask_a, SSL *s, int op)
{
     ...
     */
    sigalgslen = GMold_tls12_get_psigalgs(s, &sigalgs);
    for (i = 0; i < sigalgslen; i += 2, sigalgs += 2) {
        switch (sigalgs[1]) {
        case TLSEXT_signature_rsa:
            if (!have_rsa && GMold_tls12_sigalg_allowed(s, op, sigalgs))
                have_rsa = 1;
            break;
        case TLSEXT_signature_dsa:
            if (!have_dsa && GMold_tls12_sigalg_allowed(s, op, sigalgs))
                have_dsa = 1;
            break;
        case TLSEXT_signature_ecdsa:
            if (!have_ecdsa && GMold_tls12_sigalg_allowed(s, op, sigalgs))
                have_ecdsa = 1;
            break;
        case GMold_TLSEXT_signature_sm2sign:
            if (!have_sm2sign && GMold_tls12_sigalg_allowed(s, op, sigalgs))
                have_sm2sign = 1;
            break;
        }
    }
...
static void GMold_get_sigorhash(int *psig, int *phash, const char *str)
{
    if (strcmp(str, "RSA") == 0) {
        *psig = GMold_EVP_PKEY_RSA;
    } else if (strcmp(str, "DSA") == 0) {
        *psig = GMold_EVP_PKEY_DSA;
    } else if (strcmp(str, "ECDSA") == 0) {
        *psig = GMold_EVP_PKEY_EC;
    } else {
        *phash = GMold_OBJ_sn2nid(str);
        if (*phash == GMold_NID_undef)
            *phash = GMold_OBJ_ln2nid(str);
    }
}
...
static int GMold_sig_cb(const char *elem, int len, void *arg)
{
    sig_cb_st *sarg = arg;
    size_t i;
    char etmp[20], *p;
    ...
    *p = 0;
    ...
    GMold_get_sigorhash(&sig_alg, &hash_alg, etmp);
    GMold_get_sigorhash(&sig_alg, &hash_alg, p);
...
int GMold_tls1_set_sigalgs(CERT *c, const int *psig_nids, size_t salglen, int client)
{
    ...
    for (i = 0, sptr = sigalgs; i < salglen; i += 2) {
        rhash = GMold_tls12_find_id(*psig_nids++, GMold_tls12_md, OSSL_NELEM(GMold_tls12_md));
        rsign = GMold_tls12_find_id(*psig_nids++, GMold_tls12_sig, OSSL_NELEM(GMold_tls12_sig));
        if (rsign == TLSEXT_signature_ecdsa && rhash == GMold_TLSEXT_hash_sm3)
            rsign = GMold_TLSEXT_signature_sm2sign;
...
int GMold_tls1_set_sigalgs_list(CERT *c, const char *str, int client)
{
    sig_cb_st sig;
    sig.sigalgcnt = 0;
    if (!GMold_CONF_parse_list(str, ':', 1, GMold_sig_cb, &sig))
        return 0;
    if (c == NULL)
        return 1;
    return GMold_tls1_set_sigalgs(c, sig.sigalgs, sig.sigalgcnt, client);
}
...
static int GMold_ssl_security_cert_key(SSL *s, SSL_CTX *ctx, X509 *x, int op)
{
    int secbits = -1;
    EVP_PKEY *pkey = GMold_X509_get0_pubkey(x);
    if (pkey) {
        /*
         * If no parameters this will return -1 and fail using the default
         * security callback for any non-zero security level. This will
         ...
         * omission of parameters is never (?) done in practice.
         */
        secbits = GMold_EVP_PKEY_security_bits(pkey);
    }
    if (s)
        return GMold_ssl_security(s, op, secbits, 0, x);
    else
        return ssl_ctx_security(ctx, op, secbits, 0, x);
}
...
{
    printf("ddddddddddddddddd ssl_security_cert_sig\n");
...
static int GMold_ssl_security_cert_sig(SSL *s, SSL_CTX *ctx, X509 *x, int op)
{
    /* Lookup signature algorithm digest */
    int secbits = -1, md_nid = NID_undef, sig_nid;
    /* Don't check signature if self signed */
    if ((GMold_X509_get_extension_flags(x) & EXFLAG_SS) != 0)
        return 1;
    sig_nid = GMold_X509_get_signature_nid(x);
    if (sig_nid && GMold_OBJ_find_sigid_algs(sig_nid, &md_nid, NULL)) {
        const EVP_MD *md;
        if(md_nid == GMold_NID_sm3)
        {
            md = GMold_EVP_sm3();
            secbits = EVP_MD_size(md) * 4;
        }
        else if (md_nid != GMold_NID_undef && (md = EVP_get_digestbyname(GMold_OBJ_nid2sn(md_nid))) != NULL)
        {
            secbits = EVP_MD_size(md) * 4;
        }
    }
    if (s)
        return GMold_ssl_security(s, op, secbits, md_nid, x);
    else
...
{
    printf("ddddddddddddddddd ssl_security_cert\n");
    if (vfy)
        vfy = SSL_SECOP_PEER;
    if (is_ee) {
...
int GMold_ssl_security_cert(SSL *s, SSL_CTX *ctx, X509 *x, int vfy, int is_ee)
{
    if (vfy)
        vfy = SSL_SECOP_PEER;
    if (is_ee) {
        if (!GMold_ssl_security_cert_key(s, ctx, x, SSL_SECOP_EE_KEY | vfy))
            return SSL_R_EE_KEY_TOO_SMALL;
    } else {
        if (!GMold_ssl_security_cert_key(s, ctx, x, SSL_SECOP_CA_KEY | vfy))
            return SSL_R_CA_KEY_TOO_SMALL;
    }
    if (!GMold_ssl_security_cert_sig(s, ctx, x, SSL_SECOP_CA_MD | vfy))
        return SSL_R_CA_MD_TOO_WEAK;
    return 1;
}
...
{
    printf("ddddddddddddddddd ssl_security_cert_chain\n");
    int rv, start_idx, i;
    if (x == NULL) {
...
int GMold_ssl_security_cert_chain(SSL *s, STACK_OF(X509) *sk, X509 *x, int vfy)
{
    int rv, start_idx, i;
    if (x == NULL) {
        x = sk_X509_value(sk, 0);
    ...
    rv = GMold_ssl_security_cert(s, NULL, x, vfy, 1);
    if (rv != 1)
        return rv;

    for (i = start_idx; i < sk_X509_num(sk); i++) {
        x = sk_X509_value(sk, i);
        rv = GMold_ssl_security_cert(s, NULL, x, vfy, 0);
        if (rv != 1)
            return rv;
    }
    return 1;
