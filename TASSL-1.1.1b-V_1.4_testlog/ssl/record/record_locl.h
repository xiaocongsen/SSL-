...
__owur int ssl3_read_n(SSL *s, size_t n, size_t max, int extend, int clearold,
                       size_t *readbytes);
__owur int GMold_ssl3_read_n(SSL *s, int n, int max, int extend, int clearold);
...
__owur int GMold_ssl3_setup_read_buffer(SSL *s);

__owur int ssl3_setup_write_buffer(SSL *s, size_t numwpipes, size_t len);
__owur int GMold_ssl3_setup_write_buffer(SSL *s, unsigned int numwpipes, size_t len);
