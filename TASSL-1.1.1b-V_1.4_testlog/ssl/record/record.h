...
__owur int ssl3_write_bytes(SSL *s, int type, const void *buf, size_t len,
                            size_t *written);
__owur int GMold_ssl3_write_bytes(SSL *s, int type, const void *buf, int len, size_t *written);
int do_ssl3_write(SSL *s, int type, const unsigned char *buf,
                  size_t *pipelens, size_t numpipes,
                  int create_empty_fragment, size_t *written);
__owur int GMold_do_ssl3_write(SSL *s, int type, const unsigned char *buf,
                         unsigned int *pipelens, unsigned int numpipes,
                         int create_empty_fragment);
__owur int ssl3_read_bytes(SSL *s, int type, int *recvd_type,
                           unsigned char *buf, size_t len, int peek,
                           size_t *readbytes);
__owur int GMold_ssl3_read_bytes(SSL *s, int type, int *recvd_type, unsigned char *buf,
                    int len, int peek, size_t *readbytes);
__owur int ssl3_setup_buffers(SSL *s);
__owur int GMold_ssl3_setup_buffers(SSL *s);
...
__owur int ssl3_write_pending(SSL *s, int type, const unsigned char *buf, size_t len,
                              size_t *written);
__owur int GMold_ssl3_write_pending(SSL *s, int type, const unsigned char *buf,
                              unsigned int len);
__owur int tls1_enc(SSL *s, SSL3_RECORD *recs, size_t n_recs, int send);
__owur int GMold_tls1_enc(SSL *s, SSL3_RECORD *recs, size_t n_recs, int send);
__owur int tls1_mac(SSL *ssl, SSL3_RECORD *rec, unsigned char *md, int send);
__owur int GMold_tls1_mac(SSL *ssl, SSL3_RECORD *rec, unsigned char *md, int send);
